...
const ObjectDetailsFound: React.FC = () => {
  ...
  return (
    <div className={styles.screen}>
      <Header
        onGoBack={goBack}
        title="Objeto Achado"
        subtitle="Responda algumas perguntas sobre o objeto que você achou para que possamos cadastrá-lo em nossa base"
      />
...
export default ObjectDetailsFound;
